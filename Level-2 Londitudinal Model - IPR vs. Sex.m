...
XTA(:,6)=((XTA(:,2)).*(XTA(:,4)))         % set x value squared as a function of the predictor variable in design matrix
...
title('Integral of Pain Relief by Gender')
ylabel('IPR')
xlabel('Treatment')
hold off
